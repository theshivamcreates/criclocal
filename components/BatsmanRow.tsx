...
export function BatsmanRow({
  ...
  return (
    <div className="grid grid-cols-[1fr_2rem_2rem_2rem_2rem] sm:grid-cols-[1fr_3rem_3rem_3rem_3rem] items-center gap-1 sm:gap-2 border-b border-slate-100 py-3 text-xs sm:text-sm last:border-b-0">
      <div>
